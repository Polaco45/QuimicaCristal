# -*- coding: utf-8 -*-
"""
Migración a v18.0.1.7.9:
- read_partner ahora devuelve whatsapp_channel_id y whatsapp_account_id
- Prompt mejorado: sección sobre comandos desde canal interno con Joaco
"""
import os, logging
...
def migrate(cr, version):
    ...
    try:
        ...
        if config:
            ...
            _logger.info("✅ MIGRATION 1.7.9: prompt mejorado para comandos canal interno")
    except Exception as e:
        _logger.exception("MIGRATION 1.7.9: %s", e)
