...
#################################################################################
{
  ...
  "assets"              :  {
    ...
    "web.assets_frontend" : [
                            ...
                            'affiliate_management/static/src/js/graph_renderer.js',
                            'affiliate_management/static/src/css/website_affilite_popup.css',
                            'affiliate_management/static/src/js/affiliate_statistics.js',
                            ]
  },
